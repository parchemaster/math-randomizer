...
<<<<<<< HEAD
    ...
    function latexParserToDatabase($file,$question_id){
        ...
        foreach ($sections[0] as $match) {
            ...
            $sectionNumbers = preg_replace('/[^a-zA-Z0-9]/', '', $sectionNumbers);
            //parse tasks
            ...
            $stmt = $this->connection->prepare("INSERT INTO examples2 (section,task,solution,solution_clear,question_id) VALUES (:section, :task, :solution, :solution_clear, :question_id)");
